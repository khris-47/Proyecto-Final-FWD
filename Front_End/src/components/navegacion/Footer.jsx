    ...
    <div>
      ...
      <footer className='footer'>
        <div className='left'>
          ...
          {/* Logo de youtube */}
          <a href="https://www.youtube.com/@EntreOlasYManglares/videos">
          ...
          {/* logo de facebook  */}
          <a href="https://www.facebook.com/people/Entre-olas-y-manglares/61556946831697/">
          ...
          {/* logo de instagram  */}
          <a href="https://www.instagram.com/entre_olas_y_manglares/">
        ...
        <div className='right'>
          ...
          <a href="https://www.ucr.ac.cr/" ><img src={Ucr} alt="" /></a>

          <a href="https://srp.ucr.ac.cr/"><img src={Srp} alt="" /></a>
